...
interface LensSection2Props {
    // readonly setCurrentAlias: (alias: string) => void;
    readonly filterLensSection2?: LensStep;
...
export default function LensSection2({
    ...
    const selectedPrescription = selectedOptions["prescription_type"];

    const filteredOptions = filterByLightOption(
        filterLensSection2?.steps_options ?? [],
    ...
    return (
        <div>
            ...
            >
                {filterLensSection2?.description}
            </Text>
