export default function TruckDelivery({
    ...
    return (
        ...
        >
            ...
            />
            <path
                d="M5 17.972C3.903 17.918 3.22 17.755 2.732 17.268C2.244 16.781 2.082 16.097 2.028 15M9 18H15M19 17.972C20.097 17.918 20.78 17.755 21.268 17.268C22 16.535 22 15.357 22 13V11H17.3C16.555 11 16.183 11 15.882 10.902C15.5818 10.8045 15.309 10.6373 15.0859 10.4141C14.8627 10.191 14.6955 9.91815 14.598 9.618C14.5 9.317 14.5 8.945 14.5 8.2C14.5 7.083 14.5 6.525 14.353 6.073C14.2067 5.62277 13.9559 5.21356 13.6212 4.87882C13.2864 4.54408 12.8772 4.2933 12.427 4.147C11.975 4 11.417 4 10.3 4H2M2 8H8M2 11H6"
                stroke={stroke}
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
            />
            <path
                d="M14.5 6H16.321C17.777 6 18.504 6 19.096 6.354C19.689 6.707 20.034 7.348 20.724 8.63L22 11"
                stroke={stroke}
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
