        ...
        <div className="w-full h-screen relative flex justify-center items-end overflow-hidden">
            {services.map((service, index) => (
                <div
                    key={index}
                    className={cn(
                        "w-full h-full absolute top-0 left-0 transition-all duration-1000 flex justify-start items-center p-24",
                ...
                >
                    ...
                    >
                        <Text
                            ...
                            font="helvetica"
                            color="white"
                            className="text-left pb-6 text-5xl 2xl:text-6xl"
                        >
                            {service.description}
                        </Text>
                        <div className="w-fit mt-6">
                            <Link
                                href={service.link}
                                className="text-white secondary-button px-16 py-4 rounded-full"
                            >
                                <Text
                                    size="xl2"
                                    weight="bold"
            ...
            <Image
                src="/images/home/services/img1.png"
                alt="services"
                fill
                className={cn(
                    ...
                    {services.map((service, index) => (
                        ...
                        >
                            <Text
                                ...
                                font="helvetica"
                                color="white"
                                className="text-left lowercase text-2xl lg:text-4xl pb-6 hidden lg:block"
                            >
                                {service.title}
                            </Text>
                                ...
                                {current === index && (
                                    ...
                                    >
                                        ...
                                        <div className="w-fit mb-6">
                                            <Link
                                                href={service.link}
                                                className="text-white primary-button px-8 py-2 rounded-full"
                                            >
                                                <Text
                                                    size="xl2"
                                                    weight="normal"
                ...
                {services.map((service, index) => (
                    ...
                    >
                        <button className="bg-white/10 rounded-full border border-white cursor-pointer">
                            <Plus size={!isDesktop ? 48 : 96} fill="white" />
                        </button>
                        <div>
                            <Text
                                as="h2"
